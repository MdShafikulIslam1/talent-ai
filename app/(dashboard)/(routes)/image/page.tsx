...
import { formSchema, photoAmountOptions, resolutionsOptions } from "./constant";
  ...
  return (
    <div>
      <Heading
        ...
        description="generate your best image based on your configuration"
        icon={ImageIcon}
      ...
      <div className="px-4 lg:px-8 mb-8">
                  ...
                  <FormItem className="col-span-12 lg:col-span-6">
                    <FormControl className="m-0 p-0">
                      <Input
                        ...
                        disabled={isLoading}
                        placeholder="A picture with a lion in a street?"
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
        ...
        <div className="mt-4 space-y-4">
          ...
          {images.length === 0 && !isLoading && (
            <Empty title="No Image is generated yet" />
          )}
          {/* image show here */}
