  ...
  return (
    <div>
      <Heading
        ...
        description="Summarize your text into a short and concise summary"
        icon={MessageSquare}
        ...
        <div className="mt-4 space-y-4">
          ...
          {message && originalText && (
            <div className="relative p-6 border rounded-xl bg-violet-50 space-y-6 shadow-sm">
              {/* Original Text */}
              <div>
                <h2 className="text-lg font-bold mb-2 text-gray-800">📝 Original Text</h2>
                <p className="text-gray-700 whitespace-pre-wrap">{originalText}</p>
              </div>

              {/* Summarized Text with Copy Button */}
              <div>
                <button
                  onClick={handleCopy}
